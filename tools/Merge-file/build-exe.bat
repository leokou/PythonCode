@echo off
REM ---------------------------------------------------------------------------
REM Merge-file - build exe
REM   Targets (this dir, tools\Merge-file):
REM     - md_merger.py  -> md_merger.exe
...
REM ---- Build the entry script ----
echo ===================================================================
echo [BUILD] md_merger.exe
echo ===================================================================
"%PY%" -m PyInstaller --onefile --noconfirm --clean --distpath "%DIST%" --name md_merger "md_merger.py"
if errorlevel 1 (
    echo [FAIL] md_merger build failed
    pause
    exit /b 1
)
...
echo.
echo [DONE] Generated:
if exist "%DIST%\md_merger.exe" echo   - %DIST%\md_merger.exe
endlocal
pause
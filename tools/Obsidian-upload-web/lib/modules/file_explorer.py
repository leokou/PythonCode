...
from lib.modules import file_ops
from lib.modules import file_tree
from lib.modules import history
from lib.modules import layout_store
from lib.modules import workspace
...
def move_folder(path, direction):
    """上移/下移工作区文件夹。返回 (ok, msg, folders)。"""
    return workspace.move_folder(path, direction)
